...
export default function _layout() {
    return (
        <Tabs screenOptions={{ headerShown: false, headerTitle: '' }}>
            ...
            <Tabs.Screen name='event' options={{ tabBarIcon: ({ color, size }) => <AntDesign name="calendar" size={24} color="black" />, title: 'Events' }} />
            <Tabs.Screen name='clubs' options={{ tabBarIcon: ({ color, size }) => <Ionicons name="people-outline" size={24} color="black" />, title: 'Clubs' }} />
