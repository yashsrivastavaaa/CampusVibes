    ...
    return (
        <View>
            ...
            <View style={{ display: 'flex', alignItems: 'center', marginTop: 80 }}>
                ...
                <Text style={{ fontSize: 20 }}>Department ID : {department ? department : 'Loading...'}</Text>
                <Text style={{ fontSize: 20 }}>Designation : Student</Text>

                <TouchableOpacity style={{ backgroundColor: 'green', marginTop: 60, width: '80%', height: 50, borderRadius: 50, display: 'flex', alignItems: 'center', justifyContent: 'center' }} onPress={() => router.push('/changePassword/changePasswordScreenStd')}>
